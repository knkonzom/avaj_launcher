    ...
    public void updateConditions() {
        ...
        switch (weather) {
            ...
            case "FOG": this.coordinates.setHeight(this.coordinates.getHeight() + 1);
                        ...
                        break;
            default:
                        Logger.getLogger().logToFile("JetPlane #" + this.name + " [" + this.id + "]: unable to contact Weather Tower.");
                        break;
        }
        if (this.coordinates.getHeight() <= 0) {
            Logger.getLogger().logToFile("JetPlane #" + this.name + " [" + this.id + "]: landed/no departure.");
